...
if ($quantCategorias) {
  for ($i = 0; $i < $quantCategorias["total"]; $i++) {
    $posicao = $i;
    $nomes = "SELECT nomeCategoria AS nomCategorias FROM categoria LIMIT :posicao, 1";
    $consultaNomes = $conn->prepare($nomes);
    $consultaNomes->bindParam(":posicao", $posicao, PDO::PARAM_INT);
    $consultaNomes->execute();
        ...
        if ($nome["nomCategorias"] == $linha["categoria"]) {
          ...
          echo '<div class="card mb-4 col-md-3" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <form action="../acoesJogos/verJogo.php" method="post">
